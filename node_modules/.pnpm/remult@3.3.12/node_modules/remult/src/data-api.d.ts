...
export declare class DataApi<T = unknown> {
    ...
    private prepareWhereForManyOperation;
    ...
    actualUpdate(row: any, body: any, req: DataApiRequest, doNotSelect?: boolean): Promise<any>;
    put(response: DataApiResponse, req: DataApiRequest, id: any, body: any): Promise<void>;
    actualDelete(row: any): Promise<void>;
    delete(response: DataApiResponse, id: any): Promise<void>;
    post(body: any, req: DataApiRequest): Promise<any>;
}
