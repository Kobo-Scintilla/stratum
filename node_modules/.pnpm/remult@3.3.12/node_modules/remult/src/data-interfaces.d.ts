...
import type { GroupByOperators, EntityMetadata, MembersOnly, InsertOrUpdateOptions } from './remult3/remult3.js';
...
export interface EntityDataProviderGroupByOptions extends Pick<EntityDataProviderFindOptions, 'where' | 'limit' | 'page'> {
    group?: FieldMetadata[];
    sum?: FieldMetadata[];
    avg?: FieldMetadata[];
    min?: FieldMetadata[];
...
export declare class EntityError<entityType = unknown> extends Error implements ErrorInfo<entityType> {
