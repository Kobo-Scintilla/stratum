...
var DataApi = /** @class */ (function () {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 13:
                        _g = (_f = res).created;
                        return [4 /*yield*/, this.post(body, req)];
                            ...
                            return tslib_1.__generator(this, function (_f) {
                                switch (_f.label) {
                                    ...
                                    case 4:
                                        ...
                                        _b = (_a = result).push;
                                        return [4 /*yield*/, this.post(tslib_1.__assign(tslib_1.__assign({}, item.where), item.set), request)];
                                    case 5:
                                        _b.apply(_a, [_f.sent()]);
                                        return [3 /*break*/, 9];
                                    case 6:
                                        ...
                                        _d = (_c = result).push;
                                        return [4 /*yield*/, this.actualUpdate(r[0], item.set, request)];
                                    case 7:
                                        _d.apply(_c, [_f.sent()]);
                                        return [3 /*break*/, 9];
                                    case 8:
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        deleted_1 = 0;
                        return [4 /*yield*/, this.prepareWhereForManyOperation(body, request)];
                    case 1:
                        where_1 = _a.sent();
    ...
    DataApi.prototype.prepareWhereForManyOperation = function (body, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var where;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        where = undefined;
                        if (!((body === null || body === void 0 ? void 0 : body.where) !== 'all')) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.buildWhere(request, body)];
                    case 1:
                        where = _a.sent();
    ...
    DataApi.prototype.groupBy = function (request, body) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var findOptions, orderBy, _a, _b, element, direction, group, min, max, result, minMax, _loop_1, _c, _d, element;
            var e_3, _e, _f, _g, e_4, _h;
            var _this = this;
            ...
            return tslib_1.__generator(this, function (_q) {
                switch (_q.label) {
                    ...
                    case 1:
                                ...
                                for (_a = tslib_1.__values(body === null || body === void 0 ? void 0 : body.orderBy), _b = _a.next(); !_b.done; _b = _a.next()) {
                                    ...
                                    switch (element.operation) {
                                        ...
                                        case 'count':
                                            ...
                                            break;
                                        default:
                                            orderBy[element.field] = tslib_1.__assign(tslib_1.__assign({}, orderBy[element.field]), (_f = {}, _f[element.operation] = direction, _f));
                                            break;
                                    }
                                }
                            }
                        ...
                        group = (_j = body === null || body === void 0 ? void 0 : body.groupBy) === null || _j === void 0 ? void 0 : _j.filter(function (x) {
                            return _this.repository.fields.find(x).includedInApi();
                        });
                        min = (_k = body === null || body === void 0 ? void 0 : body.min) === null || _k === void 0 ? void 0 : _k.filter(function (x) {
                            return _this.repository.fields.find(x).includedInApi();
                        });
                        max = (_l = body === null || body === void 0 ? void 0 : body.max) === null || _l === void 0 ? void 0 : _l.filter(function (x) {
                            return _this.repository.fields.find(x).includedInApi();
                        });
                        return [4 /*yield*/, this.repository.groupBy((_g = {
                                    where: findOptions.where,
                                    limit: findOptions.limit,
                                    page: findOptions.page
                                },
                                //@ts-expect-error internal key
                                _g[remult3_js_1.GroupByForApiKey] = true,
                                _g.group = group,
                                _g.sum = (_m = body === null || body === void 0 ? void 0 : body.sum) === null || _m === void 0 ? void 0 : _m.filter(function (x) {
                                    return _this.repository.fields.find(x).includedInApi();
                                }),
                                _g.avg = (_o = body === null || body === void 0 ? void 0 : body.avg) === null || _o === void 0 ? void 0 : _o.filter(function (x) {
                                    return _this.repository.fields.find(x).includedInApi();
                                }),
                                _g.min = min,
                                _g.max = max,
                                _g.distinctCount = (_p = body === null || body === void 0 ? void 0 : body.distinctCount) === null || _p === void 0 ? void 0 : _p.filter(function (x) {
                                    return _this.repository.fields.find(x).includedInApi();
                                }),
                                _g.orderBy = orderBy,
                                _g))];
                    case 2:
                        ...
                        _loop_1 = function (element) {
                            if (minMax[element])
                                result.forEach(function (x) {
                                    var e_6, _a;
                                    try {
                                        for (var _b = (e_6 = void 0, tslib_1.__values(minMax[element])), _c = _b.next(); !_c.done; _c = _b.next()) {
                                            var f = _c.value;
                                            x[f][element] = _this.repository.fields
                                                .find(f)
                        ...
                        try {
                            for (_c = tslib_1.__values(['min', 'max']), _d = _c.next(); !_d.done; _d = _c.next()) {
                                element = _d.value;
                                _loop_1(element);
                            }
                        }
    ...
    DataApi.prototype.findOptionsFromRequest = function (request, body) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var findOptions, _a, sort, dir, limit, select, hasId_1, w;
            var _this = this;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a.where = _b.sent();
                        if (body === null || body === void 0 ? void 0 : body.args)
    ...
    DataApi.prototype.updateManyThroughPutRequest = function (response, request, body) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                if (action == 'emptyId') {
                    return [2 /*return*/, this.put(response, request, '', body)];
                }
                                ...
                                return tslib_1.__generator(this, function (_g) {
                                    switch (_g.label) {
                                        ...
                                        case 3:
                                            ...
                                            _a = false;
                                            x = _f;
                                            return [4 /*yield*/, this.actualUpdate(x, body.set, request)];
                                        case 4:
                                            _g.sent();
                                            updated++;
                                            _g.label = 5;
    ...
    DataApi.prototype.actualUpdate = function (row, body, req, doNotSelect) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var ref, options;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        options = req.get('_select') === 'none' || doNotSelect
                            ? { select: 'none' }
                            : undefined;
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, ref.toApiJson()];
                }
            });
        });
    };
    DataApi.prototype.put = function (response, req, id, body) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.doOnId(response, id, function (row) { return tslib_1.__awaiter(_this, void 0, void 0, function () { var _a, _b; return tslib_1.__generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    _b = (_a = response).success;
                                    return [4 /*yield*/, this.actualUpdate(row, body, req)];
    ...
    DataApi.prototype.post = function (body, req) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var options, insert, result_1;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        options = req.get('_select') === 'none' ? { select: 'none' } : undefined;
                            ...
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        ...
                                        return [4 /*yield*/, this.repository.getEntityRef(newr).save(options)];
                                    case 2:
                                        _a.sent();
                                        if ((options === null || options === void 0 ? void 0 : options.select) === 'none')
                                            return [2 /*return*/, undefined];
                        ...
                        result_1 = [];
                        return [4 /*yield*/, (0, context_js_1.doTransaction)(this.remult, function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                var body_2, body_2_1, item, _a, _b, e_9_1;
                                var e_9, _c;
