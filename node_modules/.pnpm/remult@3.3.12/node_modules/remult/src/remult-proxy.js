...
var RemultProxy = /** @class */ (function () {
    function RemultProxy() {
        ...
        this.repo = function () {
            ...
            result = (_a = {
                ...
                _a.insert = function (args2, args3) {
                    var _a;
                    return (_a = self
                        .remultFactory())
                        .repo.apply(_a, tslib_1.__spreadArray([], tslib_1.__read(args), false)).insert(args2, args3);
                },
                ...
                _a.update = function (a, b, c) {
                    var _a;
                    return (_a = self
                        .remultFactory())
                        .repo.apply(_a, tslib_1.__spreadArray([], tslib_1.__read(args), false)).update(a, b, c);
                },
                _a);
    ...
    RemultProxy.prototype.subscribeAuth = function (listener) {
        return remult_static_js_1.remultStatic.remultFactory().subscribeAuth(listener);
    };
