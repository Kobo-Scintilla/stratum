...
exports.FilterSerializer = exports.customDatabaseFilterToken = exports.customUrlToken = exports.NotFilter = exports.OrFilter = exports.AndFilter = exports.Filter = void 0;
    ...
    Filter.fromEntityFilter = function (entity, whereItem) {
        ...
        var _loop_1 = function (key) {
            if (Object.prototype.hasOwnProperty.call(whereItem, key)) {
                ...
                {
                    if (key == '$or') {
                        result.push(new (OrFilter.bind.apply(OrFilter, tslib_1.__spreadArray([void 0], tslib_1.__read(fieldToFilter_1.map(function (x) {
                            return Filter.fromEntityFilter(entity, x);
                        })), false)))());
                    }
                    else if (key == '$not') {
                        ...
                        result.push(new (AndFilter.bind.apply(AndFilter, tslib_1.__spreadArray([void 0], tslib_1.__read(fieldToFilter_1.map(function (x) {
                            return Filter.fromEntityFilter(entity, x);
                        })), false)))());
                    }
                        ...
                        if (!field)
                            throw new Error("Field ".concat(key, " not found in entity ").concat(entity.key));
