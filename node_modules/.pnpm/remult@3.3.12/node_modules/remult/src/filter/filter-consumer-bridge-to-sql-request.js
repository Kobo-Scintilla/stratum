...
var entityDbName_js_1 = require("./entityDbName.js");
var fieldDbName_js_1 = require("./fieldDbName.js");
            ...
            return tslib_1.__generator(this, function (_a) {
                if (val && val.length > 0)
                    this.addToWhere(this.nameProvider.$dbNameOf(col) +
                        ' in (' +
                        val
                            .map(function (x) { return toDbSql(_this.r, col, col.valueConverter.toDb(x)); })
                            .join(',') +
                        ')');
                else
        ...
        return tslib_1.__generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    _c = {};
                    return [4 /*yield*/, (0, entityDbName_js_1.entityDbName)(meta, options.wrapIdentifier)];
                case 1:
                ...
                case 3:
                    ...
                    field = _b.value;
                    return [4 /*yield*/, (0, fieldDbName_js_1.fieldDbName)(field, meta, options.wrapIdentifier, forceSqlExpression)];
                case 4:
                    r = _e.sent();
...
function toDbSql(r, field, val) {
    var _a;
    return ((_a = field.valueConverter.toDbSql) !== null && _a !== void 0 ? _a : (function (x) { return x; }))(r.param(val));
}
