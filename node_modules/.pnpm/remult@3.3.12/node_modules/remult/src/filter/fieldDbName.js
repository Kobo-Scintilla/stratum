...
exports.originalSqlExpressionKey = void 0;
...
exports.originalSqlExpressionKey = Symbol.for("originalSqlExpressionKey");
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!f[exports.originalSqlExpressionKey])
                        f[exports.originalSqlExpressionKey] = f.options.sqlExpression;
                    return [4 /*yield*/, f.options.sqlExpression(meta, undefined, undefined)];
                case 2:
                    result_1 = _a.sent();
