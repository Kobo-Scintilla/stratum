...
var zeroDate = new Date('0000-01-01');
var ValueConverters = /** @class */ (function () {
    ...
    ValueConverters.DateOnlyString = tslib_1.__assign(tslib_1.__assign({}, ValueConverters.DateOnly), { fieldTypeInDb: 'char(8)', toDb: function (d) {
            if (d === zeroDate)
                return '00000000';
