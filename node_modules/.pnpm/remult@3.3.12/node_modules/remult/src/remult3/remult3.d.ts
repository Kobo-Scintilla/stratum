...
export interface EntityRefBase<entityType> extends Subscribable {
    ...
    metadata: EntityMetadata<unknown>;
    toApiJson(): any;
...
export type FieldsMetadata<entityType> = {
    ...
    find(fieldMetadataOrKey: FieldMetadata | string): FieldMetadata<unknown, entityType>;
...
export interface FieldRef<entityType = unknown, valueType = unknown> extends Subscribable {
    error: string | undefined;
    displayValue: string;
    value: valueType;
    originalValue: valueType;
 ...
 */
export type GroupByOptions<entityType, groupByFields extends (keyof MembersOnly<entityType>)[], sumFields extends NumericKeys<entityType>[], averageFields extends NumericKeys<entityType>[], minFields extends (keyof MembersOnly<entityType>)[], maxFields extends (keyof MembersOnly<entityType>)[], distinctCountFields extends (keyof MembersOnly<entityType>)[]> = {
    /**
...
export declare const GroupByCountMember: "$count";
export declare const GroupByForApiKey: unique symbol;
export declare const GroupByOperators: readonly ["sum", "avg", "min", "max", "distinctCount"];
export type GroupByResult<entityType, groupByFields extends (keyof entityType)[], sumFields extends NumericKeys<entityType>[], averageFields extends NumericKeys<entityType>[], minFields extends NumericKeys<entityType>[], maxFields extends NumericKeys<entityType>[], distinctCountFields extends (keyof entityType)[]> = {
    [K in groupByFields[number] | sumFields[number]]: K extends groupByFields[number] ? entityType[K] : K extends sumFields[number] ? {
        sum: number;
    } : never;
} & {
    [K in averageFields[number]]: {
...
export interface Repository<entityType> {
     ...
     *      */
    findFirst(where?: EntityFilter<entityType>, options?: FindFirstOptions<entityType>): Promise<entityType | undefined>;
    /** returns the first item that matchers the `where` condition
     * @example
     ...
     *      */
    findOne(options?: FindFirstOptions<entityType>): Promise<entityType | undefined>;
    /** returns the items that matches the id. If id is undefined | null, returns null */
    findId(id: idType<entityType>, options?: FindFirstOptionsBase<entityType>): Promise<entityType | undefined | null>;
    /**
    ...
    query<Options extends QueryOptions<entityType> & {
        ...
        aggregate: Omit<GroupByOptions<entityType, never, NumericKeys<entityType>[], NumericKeys<entityType>[], (keyof MembersOnly<entityType>)[], (keyof MembersOnly<entityType>)[], (keyof MembersOnly<entityType>)[]>, 'group' | 'orderBy' | 'where' | 'limit' | 'page'>;
    } ? QueryResult<entityType, GroupByResult<entityType, never, NonNullable<Options['aggregate']['sum']>, NonNullable<Options['aggregate']['avg']>, NonNullable<Options['aggregate']['min']>, NonNullable<Options['aggregate']['max']>, NonNullable<Options['aggregate']['distinctCount']>>> : QueryResult<entityType>;
     ...
     */
    save(item: Partial<MembersOnly<entityType>>[], options?: InsertOrUpdateOptions): Promise<entityType[]>;
    save(item: Partial<MembersOnly<entityType>>, options?: InsertOrUpdateOptions): Promise<entityType>;
     ...
     */
    insert(item: Partial<MembersOnly<entityType>>[], options?: InsertOrUpdateOptions): Promise<entityType[]>;
    insert(item: Partial<MembersOnly<entityType>>, options?: InsertOrUpdateOptions): Promise<entityType>;
    /** Updates an item, based on its `id`
     * @example
     * taskRepo.update(task.id,{...task,completed:true})
     */
    update(id: idType<entityType>, item: Partial<MembersOnly<entityType>>, options?: InsertOrUpdateOptions): Promise<entityType>;
    update(id: Partial<MembersOnly<entityType>>, item: Partial<MembersOnly<entityType>>, options?: InsertOrUpdateOptions): Promise<entityType>;
    /**
...
export declare type EntityFilter<entityType> = {
    [Properties in keyof Partial<MembersOnly<entityType>>]?: (Partial<entityType>[Properties] extends number | Date | undefined | null ? ComparisonValueFilter<Partial<entityType>[Properties]> : Partial<entityType>[Properties] extends string | undefined ? Partial<entityType>[Properties] | (ContainsStringValueFilter & ComparisonValueFilter<Partial<entityType>[Properties]>) : Partial<entityType>[Properties] extends boolean | undefined | null ? ValueFilter<boolean> : Partial<entityType>[Properties] extends {
        id?: string | number;
 ...
 */
export interface QueryResult<entityType, AggregateResult = EmptyAggregateResult> {
 ...
 */
export interface RelationOptions<fromEntity, toEntity, matchIdEntity, optionsType extends FindOptionsBase<toEntity> = FindOptionsBase<toEntity>> extends Pick<FieldOptions, 'caption' | 'label'> {
    /**
