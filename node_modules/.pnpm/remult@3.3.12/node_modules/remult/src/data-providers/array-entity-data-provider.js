...
var ArrayEntityDataProvider = /** @class */ (function () {
                    ...
                    case 1:
                        ...
                        if (rows)
                            return [2 /*return*/, rows.map(function (i) {
                                    return _this.translateFromJson(i, dbNames, options === null || options === void 0 ? void 0 : options.select);
                                })];
                        return [2 /*return*/, []];
                }
            });
    ...
    //@internal
    ArrayEntityDataProvider.prototype.translateFromJson = function (row, dbNames, select) {
        var e_12, _a;
        var result = {};
        try {
            for (var _b = tslib_1.__values(this.entity.fields), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    ArrayEntityDataProvider.prototype.insert = function (data) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var names, j, idf, idDbName, _a, _b, row;
            var e_16, _c;
            var _this = this;
