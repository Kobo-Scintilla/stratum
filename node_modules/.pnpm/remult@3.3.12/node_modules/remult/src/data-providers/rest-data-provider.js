...
exports.liveQueryAction = exports.RestEntityDataProvider = exports.RestDataProvider = void 0;
...
function findOptionsToJson(options, meta) {
    ...
    if (options.select) {
        options = tslib_1.__assign(tslib_1.__assign({}, options), { select: Object.keys(options.select) });
    }
    return options;
}
//@internal
        ...
        for (var _b = tslib_1.__values([
            ...
            if (json[key] !== undefined) {
                if (key === 'where') {
                    ...
                    r[key] = json.select.reduce(function (acc, key) {
                        acc[key] = true;
                        return acc;
                    }, {});
                }
...
var RestEntityDataProvider = /** @class */ (function () {
    ...
    RestEntityDataProvider.prototype.groupBy = function (options) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var run, body, result, _loop_1, _a, _b, element;
            var e_2, _c;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        _loop_1 = function (element) {
                            if (options === null || options === void 0 ? void 0 : options[element])
                                result.forEach(function (row) {
                                    var e_4, _a;
                                    try {
                                        for (var _b = (e_4 = void 0, tslib_1.__values(options[element])), _c = _b.next(); !_c.done; _c = _b.next()) {
                                            var f = _c.value;
                        ...
                        try {
                            for (_a = tslib_1.__values(['min', 'max']), _b = _a.next(); !_b.done; _b = _a.next()) {
                                element = _b.value;
                                _loop_1(element);
                            }
                        }
    ...
    RestEntityDataProvider.prototype.update = function (id, data, options) {
        var _this = this;
        var urlArgs = [];
        if (id == '')
    ...
    RestEntityDataProvider.prototype.insert = function (data, options) {
        var _this = this;
        return this.http()
            .post(this.url() + ((options === null || options === void 0 ? void 0 : options.select) === 'none' ? '?_select=$none' : ''), this.translateToJson(data))
            .then(function (y) { return _this.translateFromJson(y); });
    };
    RestEntityDataProvider.prototype.insertMany = function (data, options) {
        var _this = this;
        return this.http()
            .post(this.url() + ((options === null || options === void 0 ? void 0 : options.select) === 'none' ? '?_select=$none' : ''), data.map(function (data) { return _this.translateToJson(data); }))
