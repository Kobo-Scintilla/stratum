                ...
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        if (entity.idMetadata.fields.length > 1) {
                            sql.push("create unique index if not exists ".concat(this.wrapIdentifier(entity.dbName + '_primary_key'), " on ").concat(e.$entityName, "  (").concat(entity.idMetadata.fields
