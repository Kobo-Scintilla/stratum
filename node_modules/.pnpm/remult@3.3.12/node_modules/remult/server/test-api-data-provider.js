...
function TestApiDataProvider(options) {
    ...
    function handleOnServer(req) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, lock.runExclusive(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                        var _this = this;
                        return tslib_1.__generator(this, function (_a) {
                            switch (_a.label) {
...
var AsyncLock = /** @class */ (function () {
    ...
    AsyncLock.prototype.runExclusive = function (fn) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var previous, resolveNext;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        previous = this.current;
                        this.current = new Promise(function (resolve) { return (resolveNext = resolve); });
                        if (!AsyncLock.enabled) return [3 /*break*/, 2];
