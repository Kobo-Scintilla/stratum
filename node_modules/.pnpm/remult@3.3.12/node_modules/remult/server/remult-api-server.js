...
exports.JobsInQueueEntity = exports.RouteImplementation = exports.EntityQueueStorage = exports.RemultServerImplementation = void 0;
...
var remult_admin_js_1 = require("./remult-admin.js");
...
function createRemultServerCore(options, serverCoreOptions) {
    ...
    if (!safeOptions.subscriptionServer) {
        safeOptions.subscriptionServer = new SseSubscriptionServer_js_1.SseSubscriptionServer();
    }
    ...
    if (safeOptions.defaultGetLimit) {
        data_api_js_1.DataApi.defaultGetLimit = safeOptions.defaultGetLimit;
    }
    if (!safeOptions.queueStorage) {
        safeOptions.queueStorage = new InMemoryQueueStorage();
    }
    var dataProvider = (0, initDataProviderOrJson_js_1.initDataProviderOrJson)(safeOptions.dataProvider);
        ...
        context_js_1.RemultAsyncLocalStorage.enable();
    {
        var allControllers = [];
        if (safeOptions.entities)
            allControllers.push.apply(allControllers, tslib_1.__spreadArray([], tslib_1.__read(safeOptions.entities), false));
        if (safeOptions.controllers)
            allControllers.push.apply(allControllers, tslib_1.__spreadArray([], tslib_1.__read(safeOptions.controllers), false));
        safeOptions.controllers = allControllers;
    }
    if (safeOptions.rootPath === undefined)
        safeOptions.rootPath = '/api';
    remult_static_js_1.remultStatic.actionInfo.runningOnServer = true;
    var bridge = new RemultServerImplementation(new inProcessQueueHandler(safeOptions.queueStorage), safeOptions, dataProvider, serverCoreOptions);
    return bridge;
}
/* @internal*/
var RemultServerImplementation = /** @class */ (function () {
    function RemultServerImplementation(queue, options, dataProvider, coreOptions) {
        ...
        var modules = (_a = options.modules) !== null && _a !== void 0 ? _a : [];
        modules.push({
            key: 'default',
            priority: 0,
            entities: (_b = options.entities) !== null && _b !== void 0 ? _b : [],
            controllers: (_c = options.controllers) !== null && _c !== void 0 ? _c : [],
            initApi: options.initApi,
            initRequest: options.initRequest,
            modules: [],
        });
        this.modulesSorted = (0, module_js_1.modulesFlatAndOrdered)(modules);
        this.entities = this.modulesSorted.flatMap(function (m) { var _a; return (_a = m.entities) !== null && _a !== void 0 ? _a : []; });
        this.controllers = this.modulesSorted.flatMap(function (m) { var _a; return (_a = m.controllers) !== null && _a !== void 0 ? _a : []; });
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.runWithRemult(function (remult) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                            var started_1, startConsoleLog, _a, _b, item, e_2_1, i, _initApi;
                            var e_2, _c;
                            return tslib_1.__generator(this, function (_d) {
                                switch (_d.label) {
                                    case 0:
                                        ...
                                        if (this.entities)
                                            entitiesMetaData.push.apply(entitiesMetaData, tslib_1.__spreadArray([], tslib_1.__read(this.entities.map(function (e) { return remult.repo(e).metadata; })), false));
                                    ...
                                    case 10:
                                        ...
                                        _d.label = 11;
                                    case 11:
                                        if (!(i < this.modulesSorted.length)) return [3 /*break*/, 14];
                                        _initApi = this.modulesSorted[i].initApi;
                                        if (!_initApi) return [3 /*break*/, 13];
                                        return [4 /*yield*/, _initApi(remult)];
                                    case 12:
                                        _d.sent();
                                        _d.label = 13;
                                    case 13:
    ...
    RemultServerImplementation.prototype.getEntities = function () {
        ...
        return this.entities.map(function (x) { return r.repo(x).metadata; });
    };
    ...
    RemultServerImplementation.prototype.registerRouter = function (r) {
        ...
        {
            try {
                for (var _c = tslib_1.__values(this.controllers), _d = _c.next(); !_d.done; _d = _c.next()) {
                    var c = _d.value;
            ...
            if (this.options.admin !== undefined && this.options.admin !== false) {
                var admin = function () {
                    return _this.process(function (remult, req, res, orig, origResponse) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                        var allowed, head, requireAuthToken, disableLiveQuery, remultAdminHtml;
                        var _a, _b, _c, _d, _e, _f, _g;
                        return tslib_1.__generator(this, function (_h) {
                            switch (_h.label) {
                                case 0:
                                    allowed = (0, isOfType_js_1.isOfType)(this.options.admin, 'allow')
                                        ? this.options.admin.allow
                                        : this.options.admin;
                                    if (!remult.isAllowed(allowed)) return [3 /*break*/, 4];
                                    if (!(((_a = orig === null || orig === void 0 ? void 0 : orig.params) === null || _a === void 0 ? void 0 : _a.id) === '__entities-metadata')) return [3 /*break*/, 1];
                                    res.success((0, remult_admin_js_1.buildEntityInfo)({
                                        remult: remult,
                                ...
                                case 1:
                                    ...
                                    if ((0, isOfType_js_1.isOfType)(this.options.admin, 'allow')) {
                                        head = (_d = (_c = (_b = this.options.admin).customHtmlHead) === null || _c === void 0 ? void 0 : _c.call(_b, remult)) !== null && _d !== void 0 ? _d : head;
                                        requireAuthToken =
                                            (_e = this.options.admin.requireAuthToken) !== null && _e !== void 0 ? _e : requireAuthToken;
                                        disableLiveQuery =
                                            (_f = this.options.admin.disableLiveQuery) !== null && _f !== void 0 ? _f : disableLiveQuery;
                                    }
                                    return [4 /*yield*/, Promise.resolve().then(function () { return tslib_1.__importStar(require('./remult-admin-html.js')); })];
                                case 2:
                                    remultAdminHtml = (_h.sent()).default;
                                    origResponse.send(remultAdminHtml({
                                        rootPath: (_g = this.options.rootPath) !== null && _g !== void 0 ? _g : '/api',
                                        head: head,
            ...
            r.route(this.options.rootPath + '/me').get(this.process(function (remult, req, res) { return tslib_1.__awaiter(_this, void 0, void 0, function () { var _a; return tslib_1.__generator(this, function (_b) {
                return [2 /*return*/, res.success((_a = remult.user) !== null && _a !== void 0 ? _a : null)];
            }); }); }));
            if (this.options.subscriptionServer instanceof SseSubscriptionServer_js_1.SseSubscriptionServer) {
                ...
                r.route(streamPath + '/subscribe').post(this.process(function (remult, _2, res, _, _1, origReq) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                    var body, _a, _b;
        ...
        this.entities.forEach(function (e) {
            _this.addEntity(e, (0, getEntityRef_js_1.getEntityKey)(e), r);
        });
    };
    RemultServerImplementation.prototype.__addEntityForTesting = function (e) {
        this.addEntity(e.entityType, e.key, this.getRouteImpl());
    };
    RemultServerImplementation.prototype.addEntity = function (e, key, r) {
        if (key != undefined)
            this.add(key, function (c) {
    ...
    RemultServerImplementation.prototype.add = function (key, dataApiFactory, r) {
        ...
        r.route(myRoute)
            .get(this.process(function (c, req, res, orig) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, dataApiFactory(c).httpGet(res, req, function () { return _this.serializeContext(c); })];
            });
        }); }))
    ...
    RemultServerImplementation.prototype.process = function (what, doNotReuseInitRequest) {
        var _this = this;
        return function (req, origRes) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, genReq, genReqPublic, myReq, myRes, err_2;
            var _this = this;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = req
                            ...
                            : { internal: {}, public: { headers: new Headers() } }, genReq = _a.internal, genReqPublic = _a.public;
                        if (req) {
                            if (!genReq.query) {
                        ...
                        myRes = new ResponseBridgeToDataApiResponse(origRes, req, genReq, this.options.error);
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 6, , 7]);
                        if (!(remult_static_js_1.remultStatic.asyncContext.isInInitRequest() &&
                            !doNotReuseInitRequest)) return [3 /*break*/, 3];
                    ...
                    case 3: return [4 /*yield*/, this.runWithRemult(function (remult) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                            var user, i, _initRequest;
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        if (!req) return [3 /*break*/, 11];
                                        ;
                                        remult.context.request = req;
                                        remult.context.headers = {
                                            get: function (key) { var _a; return (_a = genReqPublic.headers.get(key)) !== null && _a !== void 0 ? _a : undefined; },
                                            getAll: function () {
                                                var result = {};
                                                genReqPublic.headers.forEach(function (value, key) {
                                                    result[key] = value;
                                                });
                                                return result;
                                            },
                                    ...
                                    case 4:
                                        ...
                                        _a.label = 5;
                                    case 5:
                                        if (!(i < this.modulesSorted.length)) return [3 /*break*/, 8];
                                        _initRequest = this.modulesSorted[i].initRequest;
                                        if (!_initRequest) return [3 /*break*/, 7];
                                        return [4 /*yield*/, _initRequest(req, {
                                                remult: remult,
                                                get liveQueryStorage() {
                                                    return remult.liveQueryStorage;
                                                },
...
var ResponseBridgeToDataApiResponse = /** @class */ (function () {
    function ResponseBridgeToDataApiResponse(r, req, genReq, handleError) {
        this.r = r;
        this.req = req;
        this.genReq = genReq;
        this.handleError = handleError;
    }
    ResponseBridgeToDataApiResponse.prototype.forbidden = function (message) {
        if (message === void 0) { message = 'Forbidden'; }
        this.error({ message: message }, undefined, 403);
    };
                    ...
                    case 0:
                        ...
                        sendError = function (httpStatusCode, body) {
                            ...
                            console.error({
                                ...
                                url: (_b = _this.genReq) === null || _b === void 0 ? void 0 : _b.url,
                                method: (_c = _this.genReq) === null || _c === void 0 ? void 0 : _c.method,
                            });
                            var json = tslib_1.__assign(tslib_1.__assign({}, body), { message: body.message });
                            _this.setStatus(httpStatusCode).json(json);
                        };
...
var RouteImplementation = /** @class */ (function () {
                ...
                return [2 /*return*/, new Promise(function (res, rej) {
                        var response = new (/** @class */ (function () {
                            ...
                            class_1.prototype.flush = function () {
                                if ((0, isOfType_js_1.isOfType)(gRes, 'flush')) {
                                    gRes.flush();
                                }
                            };
    ...
    RouteImplementation.prototype.middleware = function (origReq, res, next) {
        var e_8, _a;
        var _b;
        var req = this.coreOptions.buildGenericRequestInfo(origReq).internal;
        var theUrl = ((_b = req.url) === null || _b === void 0 ? void 0 : _b.toString()) || '';
        ...
        if (!m)
            try {
                for (var _c = tslib_1.__values(this.starRoutes), _d = _c.next(); !_d.done; _d = _c.next()) {
                    var route = _d.value;
