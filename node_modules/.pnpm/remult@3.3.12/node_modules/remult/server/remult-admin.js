                ...
                if (info) {
                    ...
                    if (info.type === 'reference' || info.type === 'toOne') {
                        ...
                        if (relRepo.metadata.apiReadAllowed) {
                            relation = tslib_1.__assign(tslib_1.__assign({}, relInfo), { allowNull: x.allowNull, where: where, entityKey: relRepo.metadata.key, idField: idField_1, captionField: (_b = relRepo.metadata.fields
                                    .toArray()
