...
exports.KnexSchemaBuilder = exports.KnexDataProvider = void 0;
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!wrapIdentifier)
                            wrapIdentifier = function (x) { return x; };
                        repo = (0, RepositoryImplementation_js_1.getRepository)(entity);
                        _a = FilterConsumerBridgeToKnexRequest.bind;
                        return [4 /*yield*/, (0, filter_consumer_bridge_to_sql_request_js_1.dbNamesOfWithForceSqlExpression)(repo.metadata, wrapIdentifier)];
                    case 1:
                        b = new (_a.apply(FilterConsumerBridgeToKnexRequest, [void 0, _b.sent(), wrapIdentifier !== null && wrapIdentifier !== void 0 ? wrapIdentifier : wrapIdentifier]))();
                        b._addWhere = false;
...
var KnexEntityDataProvider = /** @class */ (function () {
    function KnexEntityDataProvider(entity, knex, rawSqlWrapIdentifier, dp) {
        this.entity = entity;
        this.knex = knex;
        this.rawSqlWrapIdentifier = rawSqlWrapIdentifier;
        this.dp = dp;
    }
    KnexEntityDataProvider.prototype.groupBy = function (options) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, _b;
            var _this = this;
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = sql_database_js_1.groupByImpl;
                        _b = [options];
                        return [4 /*yield*/, (0, filter_consumer_bridge_to_sql_request_js_2.dbNamesOf)(this.entity, this.dp.wrapIdentifier)];
                    case 1: return [2 /*return*/, _a.apply(void 0, _b.concat([_c.sent(), this.dp.createCommand(),
                            false,
                            function (limit, offset) {
                                var _a;
                                return ((_a = _this.knex.client.config.client) === null || _a === void 0 ? void 0 : _a.includes('mssql'))
    ...
    KnexEntityDataProvider.prototype.getEntityFrom = function (e) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        r = _a.sent();
                        return [4 /*yield*/, this.getEntityFrom(e)
                                .count()
                    ...
                    case 1:
                        ...
                        try {
                            for (_a = tslib_1.__values(this.entity.fields), _b = _a.next(); !_b.done; _b = _a.next()) {
                                x = _b.value;
                                if (options.select && !options.select.includes(x.key))
                                    continue;
                        ...
                        query = this.getEntityFrom(e).select(cols);
    ...
    KnexEntityDataProvider.prototype.update = function (id, data, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
    ...
    KnexEntityDataProvider.prototype.insert = function (data, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 9:
                        ...
                        return [7 /*endfinally*/];
                    case 10:
                        insert = this.getEntityFrom(e).insert(insertObject);
                        if (!((0, RepositoryImplementation_js_1.isAutoIncrement)(this.entity.idMetadata.field) &&
                            !((options === null || options === void 0 ? void 0 : options.select) === 'none'))) return [3 /*break*/, 15];
                    ...
                    case 11:
                        ...
                        newId_1 = result[0];
                        return [3 /*break*/, 14];
                    case 12: return [4 /*yield*/, insert.returning(this.entity.idMetadata.field.dbName)];
                    case 13:
                        result = _d.sent();
                        newId_1 = result[0][this.entity.idMetadata.field.dbName];
                        _d.label = 14;
                    case 14:
                        if ((options === null || options === void 0 ? void 0 : options.select) === 'none')
                            return [2 /*return*/, undefined];
                    ...
                    case 17:
                        if ((options === null || options === void 0 ? void 0 : options.select) === 'none')
                            return [2 /*return*/, undefined];
                        return [2 /*return*/, (0, sql_database_js_1.getRowAfterUpdate)(this.entity, this, data, undefined, 'insert')];
                }
            });
        });
    };
