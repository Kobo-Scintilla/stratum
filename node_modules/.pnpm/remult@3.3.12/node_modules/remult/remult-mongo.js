...
var MongoEntityDataProvider = /** @class */ (function () {
    ...
    MongoEntityDataProvider.prototype.translateFromDb = function (row, nameProvider, select) {
        var e_3, _a;
        var result = {};
        try {
            ...
            return tslib_1.__generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, collection
                                .find(where, op)
                                .map(function (x) { return _this.translateFromDb(x, e, options.select); })
                                .toArray()];
    ...
    MongoEntityDataProvider.prototype.update = function (id, data, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
    ...
    MongoEntityDataProvider.prototype.insert = function (data, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
