...
import { GroupByForApiKey, } from './remult3.js';
...
export const fieldOptionsEnricher = remultStatic.fieldOptionsEnricher || {
    enrichFieldOptions: (options) => options,
};
export const LabelTransformer = remultStatic.labelTransformer ||
    (remultStatic.labelTransformer = tempLabelTransformer);
export function buildLabel(label, key, remult, metaData) {
    let result = undefined;
