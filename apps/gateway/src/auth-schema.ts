// GENERATED by remult-better-auth schema generator
// 2026-06-16T19:49:06.694Z
// DO NOT EDIT - regenerate with: bun run apps/gateway/src/_gen-schema.ts
...
export class User {
  ...
  @Fields.string({required: true, validate: [Validators.unique(), Validators.email()], includeInApi: false})
  email = ''
